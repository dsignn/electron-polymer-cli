 ...
 *
 */
class DeleteModuleCommand extends process_1.ProcessAware {
    constructor() {
        super(...arguments);
    ...
    action(nameModule) {
        ...
        if (!this._validateName(nameModule)) {
            ...
            console.log(chalk.red.underline.bold(`Invalid name accept "${DeleteModuleCommand.REGEX_NAME}" given "${nameModule}"\n`));
...
DeleteModuleCommand.REGEX_NAME = /^[a-z0-9-]*$/gm;
