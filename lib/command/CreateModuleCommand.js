 ...
 *
 */
class CreateModuleCommand extends AbstractModuleCommand_1.AbstractModuleCommand {
    constructor() {
        super(...arguments);
...
`;
    ...
    _updateImportDev(nameModule) {
        const fs = require('fs');
        const path = require('path');
        const regexp = RegExp(AbstractModuleCommand_1.AbstractModuleCommand.REGEX_COMMENT, 'g');
