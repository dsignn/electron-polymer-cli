...
class Main {
    ...
    constructor(config, process) {
         ...
         *
         */
        this._container = new (require('@fluidnext/library').container.Container)();
        /**
    ...
    _initValidationContainer() {
        this._container.set('ModuleNameValidation', new (require('@fluidnext/library').validation.RegExValidation)(index_1.AbstractCommand.REGEX_NAME_MODULE, 'gm'));
        this._container.set('WebComponentNameValidation', new (require('@fluidnext/library').validation.RegExValidation)(index_1.AbstractCommand.REGEX_NAME_WEB_COMPONENT, 'gm'));
        this._container.set('DirectoryExist', new (require('@fluidnext/library').validation.DirectoryExistValidator)());
        this._container.set('DirectoryExistInPath', new (require('@fluidnext/library').validation.DirectoryExistInPathValidator)());
        this._container.set('ClassNameValidation', new (require('@fluidnext/library').validation.RegExValidation)(index_1.AbstractCommand.REGEX_NAME_CLASS, 'gm'));
    }
    /**
     *
     * @param process
