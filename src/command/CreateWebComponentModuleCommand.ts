...
export class CreateWebComponentModuleCommand extends AbstractCommand implements CommandInterface {

    public description: string = 'Create webcomponent into the module';
     ...
     */
    public action(nameModule: string, nameWebComponent: string) {
     ...
     * @return string
     */
    public templateWebComponent(nameWebComponent: string) {
...
`;
     ...
     * @return object
     */
    protected integratePackageJson(nameModule: string, nameWebComponent: string) {
     ...
     * @return {string}
     */
    protected updateImportDev(nameModule: string, nameWebComponent: string) {
     ...
     * @private
     */
    private _updateConfigFiles(nameModule: string, nameWebComponent: string) {
